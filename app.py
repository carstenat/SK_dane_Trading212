...
# 🗺️ DATABÁZA NÁZVOV FIRIEM (Slovník pre kamošov)
NAZVY_FIRIEM = {
    "AAPL": "Apple Inc.",
...
if uploaded_files:
    ...
    for _, riadok in df.iterrows():
        ...
        # Očistíme ticker od prípadných broker nápisov ako "US " alebo "_US"
